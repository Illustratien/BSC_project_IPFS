...
:::
```{r,echo=FALSE}
# Giscus comment box for Session 1
giscus_repo <- "Illustratien/BSC_project_IPFS2023"
giscus_issue_id <- "Week2: The growth of spike in winter wheat_1"
giscus_theme <- "dark_dimmed"
giscus_metadata <- list("category" = "Session 1")
giscus_script <- sprintf("https://giscus.app/client.js?t=dark_dimmed&repo=%s&issue_id=%s&metadata=%s", giscus_repo, giscus_issue_id, jsonlite::toJSON(giscus_metadata))
htmltools::tags$script(type = "text/javascript", src = giscus_script)

giscus_issue_id <- "Week2: The growth of spike in winter wheat_2"
giscus_theme <- "light"
giscus_metadata <- list("category" = "Session 2")
giscus_script <- sprintf("https://giscus.app/client.js?t=light&repo=%s&issue_id=%s&metadata=%s", giscus_repo, giscus_issue_id, jsonlite::toJSON(giscus_metadata))
htmltools::tags$script(type = "text/javascript", src = giscus_script)
```
