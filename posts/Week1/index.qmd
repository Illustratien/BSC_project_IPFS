...
::: callout-note
1.  4 basic data types: ("chr","numeric","logical","Date") 
2.  functions, documentation and data type check
3.  meaning of `%>%` and `.`  
3.  indexing with pattern matching
:::
...
::: callout-challenge
Inside your `plusone` function,
please check first whether input `x` is numeric, then proceed the process.
